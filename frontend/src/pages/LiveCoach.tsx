            ...
            <div className="practice-arena fadeIn">
              ...
              <div className="arena-left-pane">
                ...
                <div className="controls-hud">
                  <div className="timer-badge" title="Session duration (Target: 30 minutes)">
                    ⏱️ {formatTime(seconds)} <span style={{ fontSize: '0.9rem', color: '#94a3b8', fontWeight: 500 }}>/ 30:00</span>
                  </div>
